...
const About = () => {
    return(
        <div className="container">
            ...
            <br></br>
            <h4>At its core, this <em>IT Help Desk Log</em> is a to-do list that calls an API, uses React to render and update its html while having Redux stores and 
                updates the state used to render the application. This application uses React Route to navigate to the various pages. The IT Help Desk Log
